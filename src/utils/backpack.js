...
export function backpackShelf({canvasDimentions, items, solutions, heightRemaining}) {
    ...
    if (unassignedItems.length > 0 && (heightRemaining> 0)){
        backpackShelf({canvasDimentions, items: unassignedItems, solutions, heightRemaining})
    }
    return solutions
}
